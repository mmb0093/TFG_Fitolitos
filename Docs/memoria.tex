...
\author{\nombre}
\tutor{Dr. Alvar Arnaiz González y Dr. José Francisco Díez Pastor}
\date{\today}
...
\noindent Dr. Alvar Arnaiz González y Dr. José Francisco Díez Pastor, profesores del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos.
...
In order to facilitate the collection of training data of the model, a client-server system has been used in which a specialized labelling tool is provided with which experts can upload their own images and label them. Once a reasonably large set was available, it would be used to train the classifier.
